...
# Data read
data = pd.read_csv(r"C:\vscode\traffic_police.csv")
...
st. set_page_config(page_title=" Police Stop Dashboard", layout = "wide")
# Title
...
st.subheader("Policelogs Preview")
